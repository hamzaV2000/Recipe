...
import com.guru.recipe.repositories.*;
...
public class BootstrapRecipes implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public BootstrapRecipes(CategoryRepository categoryRepository, RecipeRepository recipeRepository, UnitOfMeasureRepository unitOfMeasureRepository) {
